RSpec.describe 'max_by' do
  ...
  it 'array with fewest items' do
    ...
    # write code here
    smallest_array = arrays.max_by { |array|
      -array.length
    }
  ...
  it 'most programmers' do
    ...
    # write code here
    most_programmers = programmers.max_by { |lang, progs|  progs.count }
  ...
  it 'fewest programmers' do
    ...
    # write code here
    fewest_programmers = programmers.max_by { |lang, progs| -progs.count }
