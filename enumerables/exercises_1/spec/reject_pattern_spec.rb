RSpec.describe 'reject pattern' do
  ...
  it 'removes numbers' do
    ...
    elements.each { |e| not_numbers << e unless e * 0 == 0 }
  ...
  it 'removes floats' do
    ...
    elements.each { |e| not_floats << e unless e.is_a?(Float) }
  ...
  it 'removes animals starting with vowels' do
    ...
    animals.each { |animal| remaining << animal unless 'aeiouy'.include?(animal[0]) }
  ...
  it 'removes upcased words' do
    ...
    words.each { |word| remaining << word unless word == word.upcase }
  ...
  it 'removes hashes' do
    ...
    elements.each { |e| remaining << e unless e.class == Hash }
